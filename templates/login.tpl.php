            ...
            <form action="registration.php" method="post">
                <fieldset>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="lastname" name="lastname" minlength="2" maxlength="48" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="firstname" class="col-sm-3 col-form-label">Keresztnév</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="firstname" name="firstname" minlength="2" maxlength="48" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="rusername" class="col-sm-3 col-form-label">Felhasználónév</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="rusername" name="username" minlength="4" maxlength="32" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="ruserpass" class="col-sm-3 col-form-label">Jelszó</label>
                        <div class="col-sm-9">
                            <input type="password" class="form-control" id="ruserpass" name="userpass" minlength="8" maxlength="32" required>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary float-right">Küldés</button>
                </fieldset>
